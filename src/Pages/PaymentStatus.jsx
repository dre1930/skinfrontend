    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-orange-50 px-4">
      {status === "success" && (
        <div className="flex flex-col items-center space-y-6">
          ...
          <p className="text-gray-600 font-bold">Your payment has been received</p>
           <p className="text-gray-600 font-bold">Expect your package in 5-10 working days</p><p className="text-gray-600 font-bold">An email will be sent once your package has arrived  .</p>
